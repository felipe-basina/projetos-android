package no.domain.boaviagem.provider;

import android.net.Uri;

/**
 * Created by Felipe on 09/06/2016.
 */
public class BoaViagemContract {

    public static final String AUTHORITY = "no.domain.boaviagem.provider";
    ...
    public static final class Viagem{
        public static final String CONTENT_TYPE = "vnd.android.cursor.dir/" + "vnd.no.domain.boaviagem.provider/viagem";
        public static final String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/" + "vnd.no.domain.boaviagem.provider/viagem";
    ...
    public static final class Gasto{
        public static final String CONTENT_TYPE = "vnd.android.cursor.dir/" + "vnd.no.domain.boaviagem.provider/gasto";
        public static final String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/" + "vnd.no.domain.boaviagem.provider/gasto";
