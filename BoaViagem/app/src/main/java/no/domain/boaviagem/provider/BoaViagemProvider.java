...
import no.domain.boaviagem.repository.DatabaseHelper;

import static no.domain.boaviagem.provider.BoaViagemContract.AUTHORITY;
import static no.domain.boaviagem.provider.BoaViagemContract.GASTO_PATH;
import static no.domain.boaviagem.provider.BoaViagemContract.Gasto;
import static no.domain.boaviagem.provider.BoaViagemContract.VIAGEM_PATH;
import static no.domain.boaviagem.provider.BoaViagemContract.Viagem;
...
public class BoaViagemProvider extends ContentProvider {
    ...
    public String getType(Uri uri) {
        switch (uriMatcher.match(uri)) {
            ...
            case GASTOS:
                // Mesmo valor de GASTOS_VIAGEM_ID
