...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String VIAGEM_TBL = "viagem";
    public static final String GASTO_TBL = "gasto";
    ...
    /**
     * Quando uma nova versão do aplicativo e do banco de dados for lançada,
     * o Android verificará qual versão do banco de dados o usuário possui,
     * e se esta for menor do que a atual, então o método onUpgrade será invocado
     */
    @Override
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        // db.execSQL("ALTER TABLE gasto ADD COLUMN pessoa TEXT"); // Adicionando o nome do responsável pelo gasto
    }
}
